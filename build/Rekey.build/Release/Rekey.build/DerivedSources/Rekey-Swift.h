...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Rekey",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC5Rekey11AppDelegate")
...
SWIFT_CLASS("_TtC5Rekey12DragDropView")
...
SWIFT_CLASS("_TtC5Rekey14ViewController")
@interface ViewController : NSViewController
@property (nonatomic, weak) IBOutlet DragDropView * _Null_unspecified dragDropView;
- (void)viewDidLoad;
